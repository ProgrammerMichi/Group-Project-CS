...
with col6:
    ...
    with col6_1:
        selmin_rating = st.number_input("Minimum Rating", min_value=0, max_value=10, step= 0.1)

    with col6_2:
        selmax_rating = st.number_input("Maximum Rating", min_value=0, max_value=10, value = 10, step = 0.1)
